...
export default function RenderClubs(props) {
    ...
    function getClubData(name, funds, country, league) {
        setName(name);
        setFunds(funds);
        setCountry(country);
        setLeague(league);
        ...
        setTimeout(() => {
            props.getDataForParent([clubName, clubCountry, clubLeague, clubFunds]);
        }, 150);
    ...
    return (
        <div
            ...
            onClick={() => getClubData(props.clubName, props.clubFunds, props.clubCountry, props.clubLeague)}>   {/*klik na klub -> postavlja state-ove na odgovarajuci klub*/}
            <div class="px-6 py-4">
